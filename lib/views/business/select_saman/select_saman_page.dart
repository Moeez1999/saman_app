                ...
                child: Column(
                  ...
                  children: [
                    ...
                    InkWell(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ElectronicsSaman()));
                        },
                        child: selectSamanTile(
                    ...
                    InkWell(
                        ...
                        child: selectSamanTile(
                            "furniture", 'assets/icons/furniture.png')),
                    SizedBox(
                      height: 15,
                    ),
                    InkWell(
                        ...
                        child: selectSamanTile(
                            "animals", 'assets/icons/animal.png')),
                    SizedBox(
                      height: 15,
                    ),
                    InkWell(
                    ...
                    InkWell(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => CustomSamanPage()));
                        },
                        child: selectSamanTile(
                            "customSaman", 'assets/icons/custom.png')),
                    SizedBox(
                      height: 20,
                    ),
                    Center(
